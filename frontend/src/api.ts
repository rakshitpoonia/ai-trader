...
// The activity stream is the panel's primary readout and scrolls, so pull enough
// history to be worth scrolling back through rather than just the last few lines.
export function getTraderLogs(name: string, lastN = 40): Promise<LogRow[]> {
